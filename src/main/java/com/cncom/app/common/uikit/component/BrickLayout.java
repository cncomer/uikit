...
public class BrickLayout extends ViewGroup
{
    ...
    public BrickLayout(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        if (a != null)
        {
            mMaxLines = a.getInt(R.styleable.BrickLayout_brickMaxLines, mMaxLines);
            mGap = a.getDimensionPixelSize(R.styleable.BrickLayout_brickGap, mGap);
            a.recycle();
        }
    }
    ...
    {
        return new BrickLayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    }

    @Override
    public void addView(View child, int index, LayoutParams params)
    {
        super.addView(child, index, new BrickLayoutParams(params));
    }
